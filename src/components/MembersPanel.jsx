  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white dark:bg-neutral-800 dark:border dark:border-neutral-700 rounded-lg shadow-lg w-full max-w-md p-6 max-h-[80vh] flex flex-col"
      >
          ...
          <form onSubmit={handleSubmit(onSubmitInvite)} className="mb-4">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 border border-slate-300 dark:border-neutral-600 rounded-md px-3 py-2 text-sm text-slate-800 dark:text-neutral-100 dark:bg-neutral-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                type="submit"
        ...
        <div className="flex-1 overflow-y-auto space-y-2">
          {loading ? (
            <p className="text-sm text-slate-500 dark:text-neutral-400">Cargando...</p>
          ) : (
            members.map((member) => (
              <div
                key={member.user_id}
                className="flex items-center justify-between bg-slate-50 dark:bg-neutral-900 rounded-md px-3 py-2"
              >
                <div className="min-w-0">
                  <p className="text-sm text-slate-800 dark:text-neutral-100 truncate">
